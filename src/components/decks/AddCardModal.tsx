...
export default function AddCardModal({ open, mode = "create", initialCard, onClose, onSubmit }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="bg-white w-full max-w-2xl rounded-xl shadow-lg max-h-[85vh] flex flex-col">
      ...
      {/* Prompt / Question (hidden for Sorting, Sequencing, Compare/Contrast; shown for CER to capture Scenario/Prompt) */}
      {type !== "Sorting" && type !== "Sequencing" && type !== "Compare/Contrast" && (
            <div>
        ...
        {type === "Fill in the Blank" ? (
              ...
              <textarea
                ...
                placeholder={type === "Fill in the Blank" ? "The powerhouse of the cell is the __1__. Use 'Insert Blank' to add more." : (type === "CER" ? "Enter scenario or prompt" : "Enter question stem")}
              />
              {type === "Fill in the Blank" && (
