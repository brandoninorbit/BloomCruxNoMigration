    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => router.push('/decks')} className="text-gray-600 font-medium hover:text-gray-900 transition-colors">
            Cancel
          </button>
          <button
            onClick={handleSave}
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="p-8 bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="flex items-center gap-4">
            <button
              className="flex-1 bg-[#2481f9] text-white px-5 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 shadow-sm hover:bg-blue-600 transition-colors"
            ...
            <button
              className="flex-1 border border-gray-300 text-gray-700 px-5 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
              type="button"
            >
        ...
        <div className="p-8 bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="bg-blue-100 text-[#2481f9] px-4 py-2 rounded-full font-semibold text-sm flex items-center gap-2 hover:bg-blue-200 transition-colors"
            >
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white max-w-2xl w-full rounded-xl shadow-lg p-6">
            ...
            <div className="prose prose-sm max-w-none text-gray-700">
              ...
              <p className="mt-2"><span className="font-medium">Common optional columns:</span> <span className="font-mono">BloomLevel</span>, <span className="font-mono">SelfCheck</span>, <span className="font-mono">Explanation</span>, <span className="font-mono">Id</span>.</p>
            </div>
