...
async function loadSummary(deckId: number, modeParam: string | null, hints?: { unlockedParam?: string | null; pctParam?: string | null; levelParam?: string | null }): Promise<MissionSummary> {
  ...
  let modeLabel = "Quest";
  if (modeParam) modeLabel = modeParam === "topics" ? "Topic Trek" : modeParam === "timed" ? "Timed Drill" : modeParam === "boost" ? "Boost" : modeParam === "remix" ? "Random Remix" : modeParam === "starred" ? "Starred" : modeParam === "levelup" ? "Level Up" : modeParam === "target_practice" ? "Target Practice" : "Quest";
